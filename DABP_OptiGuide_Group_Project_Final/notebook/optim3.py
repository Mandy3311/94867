...
# Load the dataset
df = pd.read_csv('/Users/enzezhao/Desktop/DABP_OptiGuide_Group_Project_Final/notebook/data/df_train.csv')
...
m.addConstr(quicksum(df.loc[i, 'is_primary'] * x[i] for i in df.index) >= constraints['min_primary'], "min_primary")
